...
from phase1.data_ingestion import load_raw_dataset
from phase1.preprocess import clean_restaurant_data, save_outputs


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run dedicated Phase 1 data pipeline.")
    parser.add_argument(
        "--dataset-id",
